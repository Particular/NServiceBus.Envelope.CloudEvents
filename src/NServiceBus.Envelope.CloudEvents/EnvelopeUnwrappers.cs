...
public class EnvelopeUnwrappers : IEnumerable<EnvelopeUnwrapper>
{
    ...
    public TUnwrapper? Find<TUnwrapper>() where TUnwrapper : EnvelopeUnwrapper
    {
        if (Unwrappers.TryGetValue(typeof(TUnwrapper), out var unwrapper))
        {
            return (TUnwrapper)unwrapper;
        }
        return null;
    }
