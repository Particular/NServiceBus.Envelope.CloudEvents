...
public class Cleanup
{
    ...
    static async Task DeleteAllBucketsWithPrefix(IAmazonS3 s3Client, string namePrefix)
    {
    ...
    static async Task DeleteAllSubscriptionsWithPrefix(IAmazonSimpleNotificationService snsClient,
    ...
    static async Task DeleteAllTopicsWithPrefix(IAmazonSimpleNotificationService snsClient,
        string topicNamePrefix)
    {
    ...
    static async Task DeleteAllQueuesWithPrefix(IAmazonSQS sqsClient, string queueNamePrefix)
    {
