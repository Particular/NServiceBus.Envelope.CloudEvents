...
{
    [Test]
    public async Task An_amqp_binary_cloud_event_is_received()
    {
    ...
    class CustomSerializationBehavior : IBehavior<IDispatchContext, IDispatchContext>
    {
        ...
        public Task Invoke(IDispatchContext context, Func<IDispatchContext, Task> next)
        {
            ...
            headers["cloudEvents:specversion"] = "1.0";
            headers["cloudEvents:type"] = "Microsoft.Storage.BlobCreated";
            headers["cloudEvents:source"] = "/subscriptions/{subscription-id}/resourceGroups/{resource-group}/providers/Microsoft.Storage/storageAccounts/{storage-account}";
            headers["cloudEvents:id"] = "9aeb0fdf-c01e-0131-0922-9eb54906e209";
            headers["cloudEvents:time"] = "2019-11-18T15:13:39.4589254Z";
